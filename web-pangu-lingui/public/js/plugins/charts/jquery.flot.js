...
//update by wanzhou begin
                                var xi = 1;
                                var maxbrkpot = s.lines.maxbrkpot - 1 || 4;
                                var mflag = false;
                                while(val == null  && xi <= j && s.lines.breakPoint && xi <= maxbrkpot){
                                    val = data[j - xi][m];
                                    if(val != null){
                                        mflag = true;
                                    }
...
//update by wanzhou begin
                    var xi = 2;
                    var maxbrkpot = series.lines.maxBrkPot || 5;
                    while(x1 == null && xi <= i / ps && series.lines.breakPoint && xi <= maxbrkpot){
                        x1 = points[i - xi * ps];
                        y1 = points[i - xi *  ps + 1];
                        xi ++;
                    }
